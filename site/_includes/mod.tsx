...
export default (
  ...
  const isGitHubHomepage = /http(s)?:\/\/(www\.)?github\.com\/.*/.test(manifest.homepage ?? "")
              ...
              {isGitHubHomepage
                ? (
                  <svg
                    ...
                    height="32"
                    fill="currentColor"
                    class="mod-homepage-icon mod-homepage-github-icon"
                    aria-hidden="true"
                  >
                    <circle class="mod-homepage-github-bg" cx="12" cy="12" r="11.5" />
